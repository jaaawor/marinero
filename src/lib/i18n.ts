...
const pl: Dictionary = {
  ...
  shopStoryTitle1: "Sprzedajemy to, co sami naprawiamy",
...
const en: Dictionary = {
  ...
  shopStoryTitle1: "We sell what we service ourselves",
...
const de: Dictionary = {
  ...
  shopStoryEyebrow1: "Service in Gdynia",
  shopStoryTitle1: "Wir verkaufen, was wir selbst warten",
...
const fr: Dictionary = {
  ...
  shopStoryTitle1: "Nous vendons ce que nous réparons",
...
const ru: Dictionary = {
  ...
  shopStoryTitle1: "Продаём то, что обслуживаем сами",
...
const uk: Dictionary = {
  ...
  shopStoryTitle1: "Продаємо те, що самі обслуговуємо",
...
const it: Dictionary = {
  ...
  shopStoryTitle1: "Vendiamo ciò che assistiamo",
...
const es: Dictionary = {
  ...
  shopStoryTitle1: "Vendemos lo que nosotros mismos reparamos",
